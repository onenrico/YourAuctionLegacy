...
public enum EMaterial {
	...
	BOW("BOW", 0),
	BOWL("BOWL", 0),
	BRAIN_CORAL("BRAIN_CORAL", 0),

	BRAIN_CORAL_BLOCK("BRAIN_CORAL_BLOCK", 0),
	BRAIN_CORAL_FAN("BRAIN_CORAL_FAN", 0),
	...
	BUBBLE_COLUMN("BUBBLE_COLUMN", 0),
	BUBBLE_CORAL("BUBBLE_CORAL", 0),

	BUBBLE_CORAL_BLOCK("BUBBLE_CORAL_BLOCK", 0),
	BUBBLE_CORAL_FAN("BUBBLE_CORAL_FAN", 0),
	...
	CUT_RED_SANDSTONE("CUT_RED_SANDSTONE", 0),

	CUT_SANDSTONE("CUT_SANDSTONE", 0),
	...
	DARK_PRISMARINE_SLAB("DARK_PRISMARINE_SLAB", 0),

	DARK_PRISMARINE_STAIRS("DARK_PRISMARINE_STAIRS", 0),

	DAYLIGHT_DETECTOR("DAYLIGHT_DETECTOR", 0),

	DEAD_BRAIN_CORAL_BLOCK("DEAD_BRAIN_CORAL_BLOCK", 0),

	DEAD_BUBBLE_CORAL_BLOCK("DEAD_BUBBLE_CORAL_BLOCK", 0),
	DEAD_BUSH("DEAD_BUSH", 0),

	DEAD_FIRE_CORAL_BLOCK("DEAD_FIRE_CORAL_BLOCK", 0),

	DEAD_HORN_CORAL_BLOCK("DEAD_HORN_CORAL_BLOCK", 0),

	DEAD_TUBE_CORAL_BLOCK("DEAD_TUBE_CORAL_BLOCK", 0),
	DEBUG_STICK("STICK", 0),
	...
	DRIED_KELP("DRIED_KELP", 0),
	DRIED_KELP_BLOCK("DRIED_KELP_BLOCK", 0),
	...
	FIRE_CORAL("FIRE_CORAL", 0),

	FIRE_CORAL_BLOCK("FIRE_CORAL_BLOCK", 0),
	FIRE_CORAL_FAN("FIRE_CORAL_FAN", 0),
	...
	HEART_OF_THE_SEA("HEART_OF_THE_SEA", 0),
	...
	HORN_CORAL("HORN_CORAL", 0),
	HORN_CORAL_BLOCK("HORN_CORAL_BLOCK", 0),

	HORN_CORAL_FAN("HORN_CORAL_FAN", 0),
	...
	NAUTILUS_SHELL("NAUTILUS_SHELL", 0),
	...
	PETRIFIED_OAK_SLAB("PETRIFIED_OAK_SLAB", 0),
	PHANTOM_MEMBRANE("PHANTOM_MEMBRANE", 0),
	...
	PRISMARINE_BRICK_SLAB("PRISMARINE_BRICK_SLAB", 0),

	PRISMARINE_BRICK_STAIRS("PRISMARINE_BRICK_STAIRS", 0),

	PRISMARINE_CRYSTALS("PRISMARINE_CRYSTALS", 0),

	PRISMARINE_SHARD("PRISMARINE_SHARD", 0),

	PRISMARINE_SLAB("PRISMARINE_SLAB", 0),
	PRISMARINE_STAIRS("PRISMARINE_STAIRS", 0),

	PUFFERFISH("RAW_FISH", 3),
	PUFFERFISH_BUCKET("PUFFERFISH_BUCKET", 0),
	...
	STRING("STRING", 0),
	STRIPPED_ACACIA_LOG("STRIPPED_ACACIA_LOG", 0),

	STRIPPED_ACACIA_WOOD("STRIPPED_ACACIA_WOOD", 0),

	STRIPPED_BIRCH_LOG("STRIPPED_BIRCH_LOG", 0),

	STRIPPED_BIRCH_WOOD("STRIPPED_BIRCH_WOOD", 0),

	STRIPPED_DARK_OAK_LOG("STRIPPED_DARK_OAK_LOG", 0),

	STRIPPED_DARK_OAK_WOOD("STRIPPED_DARK_OAK_WOOD", 0),

	STRIPPED_JUNGLE_LOG("STRIPPED_JUNGLE_LOG", 0),

	STRIPPED_JUNGLE_WOOD("STRIPPED_JUNGLE_WOOD", 0),

	STRIPPED_OAK_LOG("STRIPPED_OAK_LOG", 0),
	STRIPPED_OAK_WOOD("STRIPPED_OAK_WOOD", 0),

	STRIPPED_SPRUCE_LOG("STRIPPED_SPRUCE_LOG", 0),

	STRIPPED_SPRUCE_WOOD("STRIPPED_SPRUCE_WOOD", 0),
	...
	TUBE_CORAL("TUBE_CORAL", 0),
	TUBE_CORAL_BLOCK("TUBE_CORAL_BLOCK", 0),

	TUBE_CORAL_FAN("TUBE_CORAL_FAN", 0),
	TURTLE_EGG("MONSTER_EGG", 0),

	TURTLE_HELMET("TURTLE_HELMET", 0),
	...
	private EMaterial(final String m, final int data) {
		this.m = m;
		this.data = data;
	}
	...
	public static EMaterial fromString(String key) {
		...
		try {
			if (MathUT.strInt(key) > 0) {
				...
				final int length = (values = Material.values()).length;
				int i = 0;
				while (i < length) {
					Material m = values[i];
